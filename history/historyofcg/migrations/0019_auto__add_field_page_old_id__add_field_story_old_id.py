...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('historyofcg_page', 'old_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Story.old_id'
        db.add_column('historyofcg_story', 'old_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('historyofcg_page', 'old_id')

        # Deleting field 'Story.old_id'
        db.delete_column('historyofcg_story', 'old_id')
