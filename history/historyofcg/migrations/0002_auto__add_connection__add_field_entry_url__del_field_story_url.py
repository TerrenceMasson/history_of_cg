...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('historyofcg_entry', 'url',
                      self.gf('django.db.models.fields.URLField')(default='localhost:8000', max_length=200),
                      keep_default=False)

        # Deleting field 'Story.url'
        db.delete_column('historyofcg_story', 'url')
    ...
    def backwards(self, orm):
        ...
        db.delete_column('historyofcg_entry', 'url')

        # Adding field 'Story.url'
        db.add_column('historyofcg_story', 'url',
                      self.gf('django.db.models.fields.URLField')(default='localhost:8000', max_length=200),
                      keep_default=False)
    ...
    models = {
        ...
        'historyofcg.story': {
            'Meta': {'object_name': 'Story', '_ormbases': ['historyofcg.Entry']},
