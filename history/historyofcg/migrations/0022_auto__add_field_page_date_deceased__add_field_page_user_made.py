...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.date_deceased'
        db.add_column('historyofcg_page', 'date_deceased',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.user_made'
        db.add_column('historyofcg_page', 'user_made',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.date_deceased'
        db.delete_column('historyofcg_page', 'date_deceased')

        # Deleting field 'Page.user_made'
        db.delete_column('historyofcg_page', 'user_made')
