...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field connections on 'Page'
        db.create_table('historyofcg_page_connections', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_page', models.ForeignKey(orm['historyofcg.page'], null=False)),
            ('to_page', models.ForeignKey(orm['historyofcg.page'], null=False))
        ))
        db.create_unique('historyofcg_page_connections', ['from_page_id', 'to_page_id'])


    def backwards(self, orm):
        # Removing M2M table for field connections on 'Page'
        db.delete_table('historyofcg_page_connections')
