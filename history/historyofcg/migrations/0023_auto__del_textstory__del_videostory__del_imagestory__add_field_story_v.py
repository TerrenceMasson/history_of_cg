...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Story.video'
        db.add_column('historyofcg_story', 'video',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Story.image'
        db.add_column('historyofcg_story', 'image',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Story.text'
        db.add_column('historyofcg_story', 'text',
    ...
    def backwards(self, orm):
        ...
        db.create_table('historyofcg_videostory', (
            ('story_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['historyofcg.Story'], unique=True, primary_key=True)),
            ('video', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        ...
        # Deleting field 'Story.video'
        db.delete_column('historyofcg_story', 'video')

        # Deleting field 'Story.image'
        db.delete_column('historyofcg_story', 'image')

        # Deleting field 'Story.text'
        db.delete_column('historyofcg_story', 'text')
