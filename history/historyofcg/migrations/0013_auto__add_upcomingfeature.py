...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UpcomingFeature'
        db.create_table('historyofcg_upcomingfeature', (
        ...
        db.send_create_signal('historyofcg', ['UpcomingFeature'])


    def backwards(self, orm):
        # Deleting model 'UpcomingFeature'
        db.delete_table('historyofcg_upcomingfeature')
