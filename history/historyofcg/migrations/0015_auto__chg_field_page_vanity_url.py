...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Page.vanity_url'
        db.alter_column('historyofcg_page', 'vanity_url', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))

    def backwards(self, orm):

        # Changing field 'Page.vanity_url'
        db.alter_column('historyofcg_page', 'vanity_url', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True))
