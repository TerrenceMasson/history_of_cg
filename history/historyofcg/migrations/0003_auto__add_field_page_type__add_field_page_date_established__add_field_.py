...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.type'
        db.add_column('historyofcg_page', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['historyofcg.Category']),
                      keep_default=False)

        # Adding field 'Page.date_established'
        db.add_column('historyofcg_page', 'date_established',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 12, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'Page.homepage'
        db.add_column('historyofcg_page', 'homepage',
                      self.gf('django.db.models.fields.URLField')(default=datetime.datetime(2012, 12, 1, 0, 0), max_length=200),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Page.type'
        db.delete_column('historyofcg_page', 'type_id')

        # Deleting field 'Page.date_established'
        db.delete_column('historyofcg_page', 'date_established')

        # Deleting field 'Page.homepage'
        db.delete_column('historyofcg_page', 'homepage')
    ...
    models = {
        ...
        'historyofcg.page': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_established': ('django.db.models.fields.DateTimeField', [], {}),
            'date_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
