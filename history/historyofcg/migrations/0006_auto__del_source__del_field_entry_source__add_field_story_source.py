...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('historyofcg_entry', 'source_id')

        # Adding field 'Story.source'
        db.add_column('historyofcg_story', 'source',
                      self.gf('django.db.models.fields.CharField')(default='localhost:8000', max_length=50),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('historyofcg_entry', 'source',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='localhost:8000', to=orm['historyofcg.Source']),
                      keep_default=False)

        # Deleting field 'Story.source'
        db.delete_column('historyofcg_story', 'source')
