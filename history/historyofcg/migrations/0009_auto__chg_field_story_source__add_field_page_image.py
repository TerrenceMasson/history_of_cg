...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('historyofcg_story', 'source', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
        # Adding field 'Page.image'
        db.add_column('historyofcg_page', 'image',
                      self.gf('django.db.models.fields.URLField')(default='http://www.cargo-london.com/thumb/jags-skill-thumb-fin.jpg', max_length=200),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('historyofcg_page', 'image')
