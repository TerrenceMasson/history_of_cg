...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoStory.video'
        db.alter_column('historyofcg_videostory', 'video', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200))

    def backwards(self, orm):

        # Changing field 'VideoStory.video'
        db.alter_column('historyofcg_videostory', 'video', self.gf('django.db.models.fields.CharField')(max_length=40, unique=True))
