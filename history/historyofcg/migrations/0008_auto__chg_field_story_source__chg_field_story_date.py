...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('historyofcg_story', 'source', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Story.date'
        db.alter_column('historyofcg_story', 'date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Story.source'
        db.alter_column('historyofcg_story', 'source', self.gf('django.db.models.fields.CharField')(default='localhost:8000', max_length=50))

        # Changing field 'Story.date'
        db.alter_column('historyofcg_story', 'date', self.gf('django.db.models.fields.DateTimeField')(null=True))
