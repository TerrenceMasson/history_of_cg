...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Review.page'
        db.add_column('historyofcg_review', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['historyofcg.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Review.page'
        db.delete_column('historyofcg_review', 'page_id')
