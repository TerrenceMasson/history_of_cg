...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('historyofcg_page', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))

    def backwards(self, orm):

        # Changing field 'Page.name'
        db.alter_column('historyofcg_page', 'name', self.gf('django.db.models.fields.CharField')(max_length=40, unique=True))
